...
file_dir = args.path_dir
os.makedirs(file_dir, exist_ok = True)

cell_type_proportions.to_csv(os.path.join(file_dir, f"cell_type_proportions_pseudobulk_{args.method}.csv"))
meta.to_csv(os.path.join(file_dir, f"metadata_samples_pseudobulk_{args.method}.csv"))
log_cpm_df.to_csv(os.path.join(file_dir, f"mean_gene_expression_pseudobulk_{args.cell_type}_{args.method}.csv"))
